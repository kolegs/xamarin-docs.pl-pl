...
description: Ten dokument zawiera opis różnych sposób przechowywania danych w aplikacji platformy Xamarin.iOS i zawiera określone informacje na temat korzyści SQLite.
ms.prod: xamarin
