...
> [!IMPORTANT]
> Przed rozpoczęciem upewnij się wybrać **ręcznego inicjowania obsługi administracyjnej** w **projektu > inicjowania obsługi administracyjnej właściwości...** .

1. Podłącz urządzenie do hosta kompilacji Mac.
