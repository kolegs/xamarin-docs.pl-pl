---
title: Praca z nawigacji i fokus
...
> [!IMPORTANT]
> **Uwaga:** wywoływania `SetNeedsUpdateFocus` ma znaczenie tylko wtedy, gdy kontroler widoku jest wywoływana przed zawiera widok, który aktualnie ma fokus.
