...
[![Diagram przedstawiający ogólne omówienie architektury](architecture-images/mac-arch.png "Diagram przedstawiający ogólne omówienie architektury")](architecture-images/mac-arch-large.png)
