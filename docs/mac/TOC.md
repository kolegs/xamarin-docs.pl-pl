...
### [System macOS interfejsów API](app-fundamentals/mac-apis.md)
...
### [HttpClient i selektor implementacji protokołów SSL/TLS](~/cross-platform/macios/http-stack.md?context=xamarin/mac)
