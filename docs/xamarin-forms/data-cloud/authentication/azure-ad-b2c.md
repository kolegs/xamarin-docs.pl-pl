...
PCLs używające MSAL należy przekierować można używać Profile7. Aby uzyskać więcej informacji o PCLs, zobacz [wprowadzenie do bibliotek klas przenośnych](~/cross-platform/app-fundamentals/pcl.md).
