...
#### [Wprowadzenie](user-interface/styles/introduction.md)
#### [Style jawne](user-interface/styles/explicit.md)
#### [Style niejawne](user-interface/styles/implicit.md)
#### [Style globalne](user-interface/styles/application.md)
#### [Dziedziczenie stylów](user-interface/styles/inheritance.md)
#### [Style dynamiczne](user-interface/styles/dynamic.md)
#### [Style urządzenia](user-interface/styles/device.md)
...
##### [Platforma uniwersalna systemu Windows 10](platform/windows/installation/universal.md)
