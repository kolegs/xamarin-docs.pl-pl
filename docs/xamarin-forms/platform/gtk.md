...
4. W **Eksploratora rozwiązań**, kliknij prawym przyciskiem myszy nowy projekt GTK i wybierz **Zarządzaj pakietami NuGet**. Wybierz **Przeglądaj** , a następnie wyszukaj **platformy Xamarin.Forms** 3.0 lub późniejszej.
