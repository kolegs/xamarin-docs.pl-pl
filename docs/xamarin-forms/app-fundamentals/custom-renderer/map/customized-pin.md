...
Ta klasa definiuje `CustomPin` jako dziedziczenie właściwości [ `Pin` ](https://developer.xamarin.com/api/type/Xamarin.Forms.Maps.Pin/) klasy i dodawanie `Id`, i `Url` właściwości.
