...
[ `VideoPlayer` ](https://github.com/xamarin/xamarin-forms-samples/blob/master/CustomRenderers/VideoPlayerDemos/VideoPlayerDemos/VideoPlayerDemos/VideoPlayer.cs) Klasy jest częścią **VideoPlayerDemos** przenośnej biblioteki klas (PCL) współużytkowany platformy. Dziedziczy `View`:
