...
description: W tym artykule Eksploruje różnice między współrzędne SkiaSharp i platformy Xamarin.Forms współrzędne i pokazuje to z przykładowym kodzie.
ms.prod: xamarin
