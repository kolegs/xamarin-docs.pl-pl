...
description: W tym artykule wyjaśniono, jak określić rozmiar ciągu tekstowego renderowanych zintegrować z grafiką SkiaSharp aplikacji platformy Xamarin.Forms tekstu i pokazuje to z przykładowym kodzie.
ms.prod: xamarin
