...
description: Widoki platformy Xamarin.Forms są blokami konstrukcyjnymi interfejsów i platform przenośnych użytkownika. W tym artykule wymieniono widoki, które są objęte platformy Xamarin.Forms.
ms.prod: xamarin
