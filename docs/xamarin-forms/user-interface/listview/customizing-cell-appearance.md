...
> [!NOTE]
> **Uwaga**: w przypadku przesłaniania `OnBindingContextChanged`, upewnij się, że klasa podstawowa `OnBindingContextChanged` metoda jest wywoływana, aby odbierać zarejestrowanych delegatów `BindingContextChanged` zdarzeń.
