...
* [Visual Studio 2017 wersji 15.7 lub nowszej](https://visualstudio.microsoft.com/vs/) lub nowszego z **Mobile development z platformą .NET** obciążenia.
...
2. Dodaj **Xamarin.LiveReload** pakietu NuGet:
    ...
    [![Dodaj Xamarin na żywo Załaduj ponownie NuGet Menedżera pakietów NuGet](images/addlivereloadnuget.w157-sml.png)](images/addlivereloadnuget.w157.png#lightbox)
...
* *Wyjątek podczas ładowania zestawów: System.IO.FileNotFoundException: nie można załadować zestawu "Xamarin.Live.Reload, Version = 0.3.27.0, Culture = neutral, PublicKeyToken =".*
  ...
  Projekt hosta powinien być używany `PackageReference` zamiast `packages.config`
