...
<div id="main" class="v2">
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3 class="x-hidden-focus">Rozpocznij</h3>
                                    <p>Twórz aplikacje dla systemów Android i iOS oraz platformy uniwersalnej systemu Windows.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3 class="x-hidden-focus">Przykłady</h3>
                                    <p>Przykłady funkcji i aplikacje przykładowe.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    ...
                                    <p>Ucz się bezpłatnie w trybie online lub dołącz do naszych zajęć na żywo.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <h1 class="screenReader">Dokumentacja środowiska Xamarin</h1>
        <ul class="pivots">
            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Wprowadzenie do systemu Android</h3>
                                                    <p>Samouczki pomagające w rozpoczęciu pracy z rozszerzeniem Xamarin.Android. Upewnij się, że wszystko jest poprawnie zainstalowane, i utwórz pierwszą aplikację.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Pojęcia zaawansowane i elementy wewnętrzne</h3>
                                                    <p>Jak działa rozszerzenie Xamarin.Android.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Wear</h3>
                                                    <p>Tworzenie aplikacji dla systemu Android Wear.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Przykładowe aplikacje</h3>
                                                    <p>Przykłady na telefony i tablety z systemem Android umożliwiające szybkie rozpoczęcie pracy.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Pojęcia zaawansowane i elementy wewnętrzne</h3>
                                                    <p>Jak działa rozszerzenie Xamarin.iOS.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>watchOS</h3>
                                                    <p>Tworzenie aplikacji dla systemu watchOS.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>tvOS</h3>
                                                    <p>Tworzenie aplikacji dla telewizorów przy użyciu systemu tvOS.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Przykładowe aplikacje</h3>
                                                    <p>Aplikacje i pokazy kodu dla urządzeń iPhone, iPad, Apple Watch i Apple TV.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Pojęcia zaawansowane i elementy wewnętrzne</h3>
                                                    <p>Jak działa rozszerzenie Xamarin.Mac.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Przykładowe aplikacje</h3>
                                                    <p>Przykładowe aplikacje dla systemu macOS ułatwiające rozpoczęcie programowania w języku C# dla komputerów Mac.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Udostępnianie kodu</h3>
                                                    <p>Więcej informacji na temat różnych opcji używania wspólnego kodu i bibliotek w systemach Android, iOS i Windows.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Obsługa języków</h3>
                                                    <p>Projekty Xamarin mogą być napisane w językach C# i F# oraz korzystać z bibliotek napisanych w języku VB. Obsługiwane są również szablony Razor.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Wydajność i bezpieczeństwo</h3>
                                                    <p>Wytyczne dotyczące wydajności i bezpieczeństwa aplikacji.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Wdrażanie i debugowanie</h3>
                                                    <p>Porady dotyczące debugowania i wdrażania.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Deweloperzy aplikacji klasycznych</h3>
                                                    <p>Wskazówki dla deweloperów aplikacji klasycznych na platformie .NET zainteresowanych tworzeniem aplikacji mobilnych.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <li>
                <a href="#graphics-games">Grafika i gry</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SkiaSharp</h3>
                                                    <p>Międzyplatformowa grafika 2D dla komputerów i urządzeń przenośnych.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>UrhoSharp</h3>
                                                    <p>Międzyplatformowa grafika 3D i gry.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>CocosSharp</h3>
                                                    <p>Twórz międzyplatformowe gry 2D dla urządzeń przenośnych.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>MonoGame</h3>
                                                    <p>Twórz gry na komputery, urządzenia przenośne i konsole w języku C#.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>W kilka minut rozpocznij pracę ze środowiskiem Xamarin, korzystając z aplikacji Live Player w programie Visual Studio.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Zdalny symulator systemu iOS dla systemu Windows</h3>
                                                    <p>Korzystaj z symulatora systemu iOS przy użyciu programu Visual Studio w systemie Windows.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Poznawaj i debuguj interfejs użytkownika.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Identyfikuj i rozwiązuj problemy z wydajnością.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Interaktywna nauka języka C# i platformy Xamarin.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Osadzanie kodu .NET</h3>
                                                    <p>Umożliwia wykorzystywanie istniejącego kodu .NET z poziomu innych języków programowania.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Jak włączyć projekty Xamarin do potoku ciągłej kompilacji i integracji.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
