...
Należy ustawić `Location` uprawnień dla aplikacji. Można to zrobić, otwierając **Package.appxmanifest** i wybierając polecenie **możliwości** kartę i sprawdzanie **lokalizacji**.
