...
## <a name="android-emulator-setupandroidget-startedinstallationandroid-emulatorindexmd"></a>[Ustawienia emulatora systemu android](~/android/get-started/installation/android-emulator/index.md)
...
## <a name="android-device-setupandroidget-startedinstallationset-up-device-for-developmentmd"></a>[Ustawienia urządzenia z systemem android](~/android/get-started/installation/set-up-device-for-development.md)
