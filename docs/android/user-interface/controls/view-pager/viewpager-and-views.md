...
[![Zrzut ekranu pomocy technicznej Nuget w wersji 4 wybrane w Menedżerze pakietów NuGet](viewpager-and-views-images/01-install-support-lib-sml.png)](viewpager-and-views-images/01-install-support-lib.png)
