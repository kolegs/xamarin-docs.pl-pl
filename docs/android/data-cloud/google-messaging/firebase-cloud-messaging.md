...
[![Firebase Cloud Messaging bohater obrazu](firebase-cloud-messaging-images/preview.png)](firebase-cloud-messaging-images/preview.png#lightbox)
...
[![Diagram kroki rejestracji aplikacji](firebase-cloud-messaging-images/02-app-registration-sml.png)](firebase-cloud-messaging-images/02-app-registration.png#lightbox)
...
[![FCM korzysta z magazynu i do przodu podrzędnym obsługi wiadomości](firebase-cloud-messaging-images/03-downstream-sml.png)](firebase-cloud-messaging-images/03-downstream.png#lightbox)
...
1.  Zaloguj się do [konsoli Firebase](https://console.firebase.google.com/) z konta Google (tj. adres Gmail) i kliknij przycisk **Utwórz nowy projekt**:
    ...
    [![Utwórz nowy projekt przycisku](firebase-cloud-messaging-images/05-firebase-console-sml.png)](firebase-cloud-messaging-images/05-firebase-console.png#lightbox)
...
3.  W konsoli Firebase **omówienie**, kliknij przycisk **Firebase dodać do aplikacji systemu Android**:
    ...
    [![Dodaj Firebase do aplikacji systemu Android](firebase-cloud-messaging-images/07-add-firebase-sml.png)](firebase-cloud-messaging-images/07-add-firebase.png#lightbox)
