...
#### [Zestaw Microsoft Mobile OpenJDK (wersja zapoznawcza)](get-started/installation/openjdk.md)
...
### [Android P (wersja zapoznawcza)](platform/android-p.md)
...
### [Moduł uruchamiania](~/essentials/launcher.md?context=xamarin/android)
### [Magnetometr](~/essentials/magnetometer.md?context=xamarin/android)
### [Główny wątek](~/essentials/main-thread.md?context=xamarin/android)
...
### [Czujnik orientacji](~/essentials/orientation-sensor.md?context=xamarin/android)
### [Telefon](~/essentials/phone-dialer.md?context=xamarin/android)
### [Zasilanie](~/essentials/power.md?context=xamarin/android)
...
### [Śledzenie wersji](~/essentials/version-tracking.md?context=xamarin/android)
...
#### [Debugowanie w emulatorze](deploy-test/debugging/debug-on-emulator.md)
