...
##### [Menedżer urządzeń platformy Xamarin](get-started/installation/android-emulator/xamarin-device-manager.md)
##### [Menedżer emulatora Google](get-started/installation/android-emulator/google-emulator-manager.md)
...
#### [Wdrażanie za pomocą fragmentów](platform/fragments/implementing-with-fragments/index.md)
##### [Przewodnik](platform/fragments/implementing-with-fragments/walkthrough.md)
##### [Obsługa systemów przed wersją Honeycomb](platform/fragments/implementing-with-fragments/supporting-pre-honeycomb.md)
...
### [Usługi połączone platformy Azure](~/cross-platform/data-cloud/connected-services.md?context=xamarin/android)
...
#### [Emulator zestawu SDK systemu Android](deploy-test/debugging/android-sdk-emulator/index.md)
