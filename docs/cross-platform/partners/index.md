...
|[Ai3](http://www.ai3online.com)|Atlanta, Georgia|ai3 jest multidyscyplinarnych zespołów projektantów, architektów, artystów i thinkers udostępnianie każdego komputera klienckiego w procesie projektowania przyjemne, celowo i pełnego inspiracji|
...
|[Rozwiązania oparte na oprogramowaniu Chicago](https://chicagoit.com/)|Chicago, USA|Rozwiązania oparte na oprogramowaniu Chicago to oprogramowanie doradczych firmy z różnych, multidyscyplinarne zespołem technicznym gotowa do wdrożenia z problemów biznesowych, obejmujących sieci web, mobilnych i aplikacji baz danych|
...
|[Wysiłki oprogramowania Technologies Inc.](http://www.techendeavour.com)|Austin, Teksas|Konsultantów firmy wysiłki ocena dojrzałości Mobile Enterprise i pomóc w stawianych strategicznych mobilności organizacji na wszystkich poziomach|
...
|[Oprogramowanie miC ](http://mic-software.net/)|Fresno, urząd certyfikacji, USA|Firma Microsoft pride osoby w ofercie dotyczącej zamawianych usługi, w pełni dostosowane do potrzeb indywidualnych klientów|
...
|[Millipede](http://millipede.com.au)|Melbourne, Australia|Millipede jest częścią WPP, globalna firma z ponad 8000 osobami. Jesteśmy bardzo creative grupy programistów i projektantów UX eksperci skupić się na rozwijaniu lepsze, bardziej wydajnych rozwiązań mobilnych z bezpiecznego odbiorców dla banków i aplikacje dla przedsiębiorstw narzędzia do gry na urządzenia przenośne.|
|[Oakton](https://www.oakton.com.au/)|Melbourne, Miasto Brisbane, Canberra, Sydney, Adelajda, Perth|Dzięki usługom end-to-end i rozwiązań i ponad 30 lat doświadczenia jesteśmy tutaj uprościć technologii, zwiększenia elastyczności, zwiększenie zaangażowania za pomocą klientami i pracownikami oraz bardziej dziedziczyć inwestycji w technologię.|
|[Obiquitech](http://www.obiquitech.com/)|Sydney NSW, Australia|Tworzenie aplikacji natywnych. Wszystkie platformy.|
|[Ookitech](http://www.ookitech.com.au)|Brisbane QLD, Australia|Projektowanie atrakcyjnych i technologii side-by-side. Opracowujemy inteligentnych produktów, aby pomóc w tym cyfrowego ery.|
|[Orbital8](http://www.orbital8.com.au)|Melbourne, Australia|Orbital8 to specjaliści ds. rozwoju specjalnie zapasów oprogramowania dla przedsiębiorstw, sieci web i platform urządzeń przenośnych. Naszym głównym celem jest stałe dostarczanie oprogramowania innowacyjne jeszcze proste i ekonomiczne rozwiązań w zakresie rzeczywistej wartości biznesowej dla naszych klientów. Możemy określić główną przyczynę pride na możliwości interpretacji i przewidywać potrzeby klientów i dostarczać rozwiązania, które przekracza ich oczekiwania. |
|[Czysty rozwiązania](http://www.puresolutions-online.com/Home)|Sydney NSW, Australia|Zatwierdzone zespołu ekspertów w zakresie ich interesuję się pomocą w tworzeniu najlepszych rozwiązań przez połączenie biznesowych i technologicznych.|
|[Readify](http://readify.net)|Docklands, VIC 3008 Australia|Readify zdobyła globalnego rozpoznawania ich możliwości ułatwić klientom tworzyć oprogramowanie, która napędza współpracy, wydajności, rozwój i rentowności. Ich możliwości, aby ułatwić klientom jest bezpośrednio w wyniku stosowania procesami opracowywania oprogramowania w usłudze najlepsze praktyki i wykorzystujących liderów deweloperów. Mogą to zrobić za pośrednictwem procesu rekrutacji rygorystyczne, opartych na elementów równorzędnych i Kontynuuj inwestowania w ich osób rozwoju, zapewnienie, że swoich umiejętności pozostają na czele industry knowledge.|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[3factr](http://3factr.be/)|Edegem, Belgia|3factr wynosi 100%, koncentruje się na programowanie aplikacji mobilnych platformy Xamarin przy użyciu divers integracji interfejsu API. Theyprovide zarówno doradztwa jako fabryki wewnętrznych rozwoju oprogramowania Xamarin iOS, Android oraz aplikacjach platformy UWP.|
|[CaveBirdLabs](http://www.cavebirdlabs.com/)|Antwerpia, Belgia|CaveBirdLabs jest studia opracowywania aplikacji mobilnych w Belgia, która koncentruje się na temat tworzenia atrakcyjnych aplikacji dla urządzeń przenośnych interaktywne|
|[Euricom NV](http://www.euri.com)|Mechelen, Belgia|Opracowujemy dostosowane oprogramowanie przy użyciu technologii .NET i języka JavaScript dla i wraz z klienta|
|[Przepływ pilotażowych CVBA](http://www.flowpilots.com)|Antwerpia, Belgia|Przepływ projektów pilotażowych, kompilacje, wdraża i zarządza cyfrowego narzędzi, które ułatwiają klientom zwiększyć przychody, zmniejszenie kosztów lub Przenieś wolności i elastyczności w swoim pracownikom.|
|[KENZE](http://www.kenze.be)|Mechelen, Belgia|Microsoft .NET projecten en gerelateerde technologieën.  De drie belangrijkste pijlers binnen de organisatie zijn mensen, kennis en mensenkennis, mają zij vormen de podstawy voor kwalitatieve succesvolle projecten en tevreden klanten. |
|[Levelapp](http://www.levelapp.be)|Hoeilaart, Belgia|Jesteśmy Levelapp pełnej przenośnych Agencji. Firma Microsoft, które działają jako deweloperów oprogramowania. Możemy utworzyć aplikacji między platformami, które w zakresie dopasowania i napędzania swoją wizję strategiczne. Firma Microsoft dostarczaj wartość klientów, partnerów i pracowników. |
|[Realdolmen](http://www.realdolmen.com/)|Huizingen, Belgia Kontich, Belgia Lummen, Belgia Gandawa, Belgia Harelbeke, Belgia Namur, Belgia Mons, Belgia|Mobile stanowi nowy standard. Prawie wszystkie firmy muszą usług mobilnych lub aplikacji, aby zachować konkurencyjność. Ale mobilnej strategii samodzielnie wystarczającej; wszystko, co musi zostać w pełni zintegrowane w infrastrukturze ogólnych zadań konfiguracji początkowej, łącznie z chmury, zabezpieczenia, ERP i tak dalej. W Realdolmen nazywanej połączona działalności.|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Grupo Viceri](http://www.viceri.com.br)|Jundiaí, Brazylia|Firma Microsoft zapewnia sieci web, programowanie aplikacji mobilnych i usługi analiz biznesowych|
|[Superactive rozwiązania](http://www.superactive.com.br/)|Brazylia|Superactive zestawu dostatecznej empresa especializada em desenvolvimento de soluções tecnológicas inovadoras com foco na TI Estratégica, otimizando processos, de forma fornecer resultados rápidos e seguros para systemu operacyjnego seus clientes. |
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Apcurium](http://www.apcurium.com)|Montreal, Kanada|Apcurium opracowuje rozwiązań mobilnych, które skupionej firmy oczekiwania strategie i użytkowników urządzeń przenośnych już dziś, platform i technologii.|
|[Laboratoria BSI](https://bsilabs.ca/)|Toronto, Kanada|Laboratoria BSI jest pełne doradztwo w zakresie, który specjalizuje się w mobilnej strategii, projekt środowiska użytkownika/interfejsu użytkownika, tworzenie aplikacji mobilnych i integracji systemów.|
|[Clearbridge Mobile](https://clearbridgemobile.com/)|Toronto, Kanada|Clearbridge Mobile to firma tworząca aplikację mobilną wielokrotnie nagradzany pełnego stosu, oferujący usługi projektowanie skoncentrowane na użytkowniku produktu|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Datatech działem IT Rozwiązania LTD](http://www.datatech.com.cy)|Cypr|Datatech działem IT Ltd rozwiązania to wiodący dostawca rozwiązań technologicznych w zakresie zarządzania zawartością w przedsiębiorstwie, zarządzania łańcuchem dostaw i rozwiązań mobilnych|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[DevMasters](http://www.devmasters.cz/)|Praga, Czechy|DevMasters to firma czeski IT skupia się na rozwój rozwiązań i aplikacji|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Bureauet aplikacji](https://appbureauet.dk/)|Svendborg, Dania|Bureauet aplikacji jest firma tworząca aplikację|
...
|[ApS Comet.DK (CometPeople)](http://comet.dk)|Kopenhaga, Dania|Comet jest dom rozwoju, pozwalającą na tworzenie aplikacji dla urządzeń przenośnych do najnowszych platform urządzeń przenośnych, np. iPhone, iPad, Android i Windows Phone|
|[Commentor DK](http://commentor.dk)|Aalborg, Dania|Commentor ma ponieważ 2000 przewiduje aplikacji o kluczowym znaczeniu do największych firm w Danii|
|[Świętujemy cud](https://miracle.dk/)|Ballerup, Dania|Świętujemy cud firma Microsoft dążyć do naszych przyczynić się do cyfrowego Dania. Możemy to zrobić, dostarczanie najwyższej jakości rozwiązań IT prywatnej i publicznej firmy z naszych 3 lokalizacji na całym Dania|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Maven S.R.L.](http://www.maven.do)|Dominikana|Maven to mała firma z marzeń big Data. Została założona w 2012 jako sposób oferuje świeży, najlepszych rozwiązań w zakresie jakości i różnorodne oprogramowania w Republika Dominikańska. Celem możemy zaoferować klientom bezpieczne jakość oprogramowania i w ten sposób ustanowienia relacji zaufania i odpowiedzialności wobec ich artykuły pierwszej potrzeby.|
|[Solvex Dominicana](http://www.solvex.com.do)||Solvex wartości doświadczenie zawodowe. Firma ustanowionych w 2014 r. ma teraz 200 programistów ponad których 80 procent ma co najmniej 5 lat doświadczenia w dostarczaniu oprogramowania. |
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[ITWorx](http://www.itworx.com)|Kair, Egipt|ITWORX jest globalne przedsiębiorstwa usług IT zapewnienie rozwiązań opartych na chmurze i lokalnych dla organizacji wiodących na świecie, z naciskiem na Advanced Analytics, pakietu Enterprise Mobility, zarządzanie wydajnością i CRM.|
|[Programowanie Jios](https://www.jiosdev.com/)|Egipt|Tworzenie Jios jest stabilna szybko rozwijająca się firma dostarczanie technologii konsultacji i outsourcingu specjalizującym się w tworzenia niestandardowych aplikacji, usług w chmurze i aplikacji mobilnych usługi. |
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Altran (Francja)](http://www.altran.fr/)|Paryż, Francja|Altran jest world lider w zakresie inżynierii i usługi R & D|
|[Arolla](http://www.arolla.fr/)|Paryż, Francja|Arolla jest doradcze firma specjalizująca się w najbardziej zaawansowane techniki tworzenia oprogramowania.|
|[Cellenza](http://www.cellenza.com)|Paryż, Francja|Cellenza się doradztwem wiedzy technicznej i implementacji wyłącznie dedykowanego technologii firmy Microsoft i metody agile|
|[Chloro](http://www.chloro.eu)|Selestat, Francja|Chloro specjalizuje się w projektowaniu i wytwarzaniu dostosowane aplikacje mobilne, które mają na celu Przenieś zysk w produktywności i szybkiej reakcji|
|[Grupa DevoTeam](http://www.devoteam.com)|Paryż, Francja|W Devoteam możemy dostarczać Nowatorska technologia doradczych dla firm|
|[Exakis](http://www.exakis.com)|Paryż, Francja|Exakis pomaga firmom, aby tworzyć innowacyjne projekty i informacje zabezpieczeń systemu. Zorientowane na użytkownika, opracowywanie rozwiązań opartych na technologiach firmy Microsoft, łącząc projektu i innowacji|
|[Ideine](http://ideine.fr/en/ideine/)|Roubaix, Francja|Specjalista ds. programowania międzyplatformowych, Ideine projekty oraz opracowuje niestandardowe, innowacyjnych i wydajne aplikacje mobilne.|
|[Nieskończone kwadrat](http://www.infinitesquare.com)|Paryż, Francja|Kwadrat nieskończone misją jest projektować i tworzyć innowacyjne aplikacje i lepszą jakość imieniu swoich klientów, małych i dużych firm, w najlepszych relacji zaufania i winning ze sobą.|
|[Isiasoft](http://www.isiasoft.com/)|Paryż, Francja Lyon, Francja|ISEO zapewnia szerokie spektrum usług do programowania i consultacy oprogramowania|
...
|[systemy msg grupy dostępności](http://www.msg.group/)|Berlin, Niemcy Kolonia, Niemcy Szpital uniwersytecki Hamburg, Niemcy; Frankfurt, Niemcy Norymberga, Niemcy Miasto rękaw, JORK, USA; M.in. Basel, Szwajcaria; Wiedeń, Austria|komunikat jest niezależny, międzynarodowych towarowymi grupy firm z ponad 6000 pracowników na świecie, oferując liczne kompleksowych usług doradczych creative, strategicznych i potencjalne rozwiązania IT inteligentnego, trwałego i o wysokiej wartości dodanej szerokie spektrum branż.|
|[DALEJ GmbH Monachium](http://www.next-munich.com)|Monachium, Niemcy|Czy B2C, B2B, produktywności i innymi strategiami mobilnych — przyszłość rozwiązań mobilnych rozpoczyna się teraz. DALEJ Monachium przechodzi szczegółowo i systematycznie dotyczy wszystkich składników, które przyczyniają się do pomyślnego "aplikacji — biznesowych". DALEJ Monachium zbiera we wszystkich obszarach projektowania i programowania, pozycjonowanie i programy na urządzeniach przenośnych przy użyciu 10-letnie doświadczenie marketingowe.|
|[prodot GmbH](https://prodot.de)|Duisburg, Niemcy|Prodot rozumie wizje klientów; działają ręcznie — dostępnych z Tobą w celu mapowania zakładanych wyników. Interfejsy użytkownika intuicyjne, projekty elegancki, technologicznego wiedzę i sprawdzające przyszłość są istotne elementy swoich rozwiązań. Krótko mówiąc, wydajne cykle opracowują stały, zaawansowane i długotrwałych oprogramowania do własnych potrzeb na podstawie technologii firmy Microsoft i standardowych produktów, takich jak SAP.|
|[SDX AG](http://www.sdx-ag.de)|Menem Frankfurt, Hesse, Niemcy Monachium, Niemcy; Bawaria, Niemcy|Usuń freuen szwajcarski WIR, Sie unserem neuen Hauptsitz wiadomości błyskawicznych Frankfurter Westhafen begrüßen zu können. Unsere Büroräume befinden sich wiadomości błyskawicznych 2. OG wiadomości błyskawicznych Westhafenhaus, Speicherstraße 1 unmittelbar neben dem Westhafentower.|
|[SkyTest](http://business.skytest.com)|Erlangen, Niemcy|Możemy tworzyć niestandardowe aplikacje natywne i opartych na sieci web przy użyciu najnowszych technologii i platform, takich jak Xamarin™. Skorzystaj z naszych długoterminowe pogłębiające wiedzę z zakresu. NET™ programowania i zaawansowane usługi wewnętrznej bazy danych.|
|[Software2Business GmbH](http://software2business.de/Service/MobileApp/EN)||Software2Business GmbH oferuje pełną usługę do opracowywania aplikacji — i współpracy, które będą korzystać. Odkryj potoku tworzenia aplikacji i narzędzi, używamy. |
|[XITASO GmbH](http://www.xitaso.com)|Augsburg, Niemcy|XITASO udostępnia usługi dla klientów B2B doradcze identyfikuje digitization rynkowych, optymalizuje procesów biznesowych, tworzy strategie cyfrowe i opracowuje i innowacyjne oprogramowanie.|
|[Z√ºhlke](http://www.zuehlke.com/ch/en/)|Zurych, Szwajcaria; Frankfurt, Niemcy Szpital uniwersytecki Hamburg, Niemcy; Hannover, Niemcy Monachium, Niemcy; Stuttgart, Niemcy Wiedeń, Austria|Opracowujemy finansowo pomyślne produktów, usług i modeli biznesowych — od pomysłu do wdrożenia — za pomocą rysowania na środowisko 1000 wewnętrznych ekspertów oraz ponad 10 000 pomyślne projektów.|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Entersoft SA](https://www.entersoft.eu)|Kallithea, Grecja|Entersoft to wiodący firmy entreprise oprogramowania i usług dostawca innowacyjnych i pełny zakres wysokiej jakości usług i pomocy technicznej do zapewnienia sprawnego zoptymalizowanego dla swoich klientów|


## <a name="hong-kong"></a>SRA Hongkong

| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Unissoft technologii Co. Ltd.](http://www.inas.online/en/Index.php)|SRA Hongkong|Nasze podstawowa technologia za oprogramowanie do zarządzania archiwa Hua Tsing (lub TH-AMS™ w skrócie) został zalecane produktu administracji archiwa stanu Chiny przez długi czas, więc, jest również powszechnie używany przez Rząd, branżach, w tym ropa naftowa i chemicznych; w różnych firmach, takich jak działa nawadniania metalurgia telecom i nieruchomości---za pośrednictwem tradycyjnych lokalnych modelu licencjonowania. |
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Winogronowego rozwiązania](http://grape.hu/)|Budapeszt, Węgry|Winogronowego rozwiązań jest określana w 2006 firma tworząca oprogramowanie dynamicznych. Przede wszystkim opracowywania niestandardowych aplikacji biznesowych dla naszych klientów lokalnych i międzynarodowych. |
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Włączne NA technologii GAVS](http://www.gavstech.com)|Chennai (Madras), Indie|GAVS Technologies to globalny IT usługi i rozwiązania dostawca dla klientów w wielu przypadkach branży|
|[Greynubo](http://www.greynubo.com/)|Singapur; Bengaluru, Indie|GreyNubo składa się z zespołu zatwierdzone specjalistów, którzy mają wieloletnim doświadczeniu domeny w systemów CRM i CPQ i Mobile sprzężonych z silną foundation na platformie usługi Salesforce|
|[MobMaxime](http://www.mobmaxime.com)|Ahmedabad, Indie |Firma Microsoft porozmawiać na temat wizji produktu i zdecyduj, z Tobą czy firma Microsoft jest dobrym rozwiązaniem dla projektu. Jeśli firma Microsoft, wyślemy Ci Szacowanie projektów, do przejrzenia.|
|[Ograniczone okno podręczne technologii prywatne](http://www.popuptechnologies.com)|Mumbaj (Bombaj)|Okno podręczne technologii cheeseburger ponownie 5 lat i od tego momentu były początkowych w środowisku obejmującym urządzenia mobilne. Siedzibą Mumbaj (Bombaj), technologii menu podręczne jest firmą rozwiązań mobilnych stale wkładać w przypadku nowych technologii. Z pakietem więcej niż 100 + aplikacje mobilne na wszystkich platformach — iOS, Android, Windows, Xamarin, Blackberry, Html5, TIZEN i progresywnego aplikacji sieci Web.|
|[Sasken komunikacji technologii Limited](http://www.sasken.com)|Mumbaj (Bombaj), Indie|Sasken jest łatwiejsze postrzeganie pozostawanie lepiej gdziekolwiek się znajdują. Więcej branżach, takich jak automatyczne electronics, z elektroniką, sprzedaży detalicznej i branży opieki zdrowotnej widzisz łączności z chmurą jako konieczność wraz z opartych na danych i podejmowania decyzji w czasie rzeczywistym. Przy użyciu domeny niezrównaną kompetencji komunikacji i przetwarzanie multimediów są one poised na krytyczne wyzwania, które manifesty branży. Pracują z ich odpowiedników w ekosystemie do świadczenia usług najwyższy w środowisku nowego, rozwijające się połączonych urządzeń.|
|[ServPRO technologii Pvt Ltd](http://www.servpro.in)|Mumbaj (Bombaj), Indie|ServPRO, markę, którą oznacza "Obsługująca aktywnie" została założona w 2009 roku przez Pushpinder Bhatia Pan. ServPRO jest wiodących rozwiązań IT i dostawcy usług dedykowanych do dostarczania na wiele segmentów pionowych, tym sposób & odzieży, przemysł & bankowości, gaz, produkcji, handlu detalicznego, środków farmaceutycznych, Agro, krytyczne dla działania firmy i innowacyjne rozwiązania IT FMCG/Szybkozbywalnych, kruszców EXIM i różnych branżowych branży.|
|[Oprogramowanie Taritas Pvt rozwiązania. Ltd.](http://www.taritas.com/)|Bengaluru, Karnataka, Indie Jabalpur, Madhja Pradeś, Indie|Taritas jest firmy zajmującej się oprogramowaniem outsourcingu, która dostarcza rozwiązania wiodących w wielu branżach. Kompleksową wiedzę na temat tworzenia oprogramowania i aplikacji w połączeniu z oszczędność kosztów w ramach offshoringu dla pozwala nam na świadczenie usług deweloperskich wysokiej jakości, przede wszystkim usłudze minimalizując koszty projektu i maksymalizacji zysków naszych klientów. Postępujemy zgodnie z metody "Kliknij prawym przyciskiem myszy po raz pierwszy, na czas i budżet". |
|[Tech Mahindra](https://techmahindra.com)|Bengaluru|Reprezentuje tech Mahindra połączonym świecie oferty innowacyjnych i zorientowanego na klienta usług informatycznych, jak i rozwiązania, umożliwiając przedsiębiorstwa, kojarzy oraz społeczeństwa do powstania "są Ń. Firma Microsoft są firmy 4.4 mld USD, z profesjonalistami 117,600 + WE 90 krajach, pomagając za pośrednictwem 840 + globalnych klientów, w tym z listy Fortune 500.|
|[TechAhead Pvt oprogramowania. Ltd.](http://www.techaheadcorp.com)|Geofizyki na uniwersytecie, New; Noida, Indie|Jesteśmy w stanie tworzyć rozwiązania mobilności, które przyspieszanie cyfrowej transformacji w miejscu pracy, zwiększyć produktywność, wymuszania zabezpieczeń i pozwalać na pracę z dowolnego miejsca i w dowolnym momencie. Twórz rozwiązania mobilności najlepszego dopasowania na potrzeby modelu przedsiębiorstwa i cele biznesowe, które doskonale resonate wrażenie na marki, penetracji rynku, integracja z usługą i oczekiwania klientów.|
|[Zalet usługi konsultingowe drzewa](http://www.walkingtree.in/)|Hyderabad, Indie|Zalet drzewa IT oprogramowania i usług dostawcy jest rozpoznawane dla jego fascynacją technologią. Działają one jako zespół programistyczny produktu lub zespołu inżynieryjnego wewnętrznej bazy danych dla klientów na całym świecie.|
|[Przeszukiwarki sieci Web](http://www.webspiders.com)|Warszawa, Polska Londyn, Zjednoczone Królestwo; Singapur; Indie|Przeszukiwarki sieci Web (WS) jest producenta oprogramowania przedsiębiorstwa, który zajmuje się opracowywaniem produktów na potrzeby marketingu i godzinę na dysku do przodu "stopnia zaangażowania użytkowników" przy użyciu mobilności i prowadzone sztuczna Inteligencja Botów.|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Technologia greenfinch](https://greenfinch.ie/)|Dublin, Irlandia|Firmy Software engineering koncentruje się na innowacji i jakość. Firma Microsoft zapewnia naszym klientom usłudze projektowanie, kompilowanie i Zarządzaj, aby pomóc im sprostać wyzwaniom swoją działalność w dzisiejszym świecie szybko zmieniających|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Cortis Lentini](http://www.cortislentini.com)|Mediolan, Włochy; Rzym, Włochy Bergamo; Włochy|Cortis Lentini provices innowacyjne infrastrukturę oraz usługi usługowa Technical Preview|
|[Dataexpert S.r.l.](http://www.dataexpert.it)|Mediolan, Włochy|Dataexpert jest liderem w dostarczaniu usług IT o wysokiej wartości innowacyjne, zorientowane na usługę, łatwo ją zintegrować z istniejącymi infrastrukturami technologii, szybkie i proste wdrożenie|
|[Należy pamiętać fabryki](http://www.factorymind.com)|Trento, Włochy|Pamiętaj fabryki jest cooperative młodych i dynamiczne, składające się z zespołu pasjonują deweloperom i rozpoczęcia dla komputera nauki, technologii i innowacji.|
|[Piąty Ingenium](https://fifthingenium.com/)|Mediolan, Włochy|FifthIngenium jest włoski firmy IT specjalizująca się w aplikacji mobilnej, rozwiązań w chmurze i rozwijających się technologii|
|[Gaia S.r.l.](http://www.gaia.is.it/en/)|Mediolan, Włochy|Gaia to firmie projektowej środowiska, który tworzy cyfrowe ekosystemów przeznaczone dla osób.|
|[Giuneco s.r.l.](http://www.giuneco.it/)|Florencja, Włochy|Celem firmy jest wykorzystać nowe technologie (dotyczą głównie na świecie firmy Microsoft), aby utworzyć skuteczne i wydajne rozwiązania za pomocą szczególną uwagę na (UX) użytecznością i utrzymaniem|
|[Lemcube](http://www.lemcube.com)|Paese, Treviso, Włochy|Firmy doradcze z 10-letnie doświadczenie z platformą Microsoft .net. Naszym klientom są branżach logistycznych, konserwacja i mobilności. Oferujemy szkolenia i szkolenia w zadaniu.|
|[Mahiz Srl](http://www.mahiz.it/)|Włochy|Artisans oprogramowania, Mahiz pomaga firmom na tworzenie lepszych produktów, zapewniając dwadzieścia lat doświadczenia w dziedzinie technologii informatycznych. Swojej misji jest identyfikatorów rid na świecie zły oprogramowania, które blokuje rozwój produktu, procesy i pomysłów. |
|[Proge oprogramowania](http://www.progesoftware.com)|Rzym, Włochy Mediolan, Włochy|Firma Microsoft ma produkują projektów o dużej zawartości technologiczne dla dużych i średnich firm, krajowych i międzynarodowych, od 1985 roku. Firma Microsoft zapewnia wszystkie niezbędne do projektowania, tworzenia i obsługi systemów informatycznych w firmach działania|
|[PS Przenośnych srl](http://www.psmobile.it)|Bolonia, Włochy|PS Filozofia Mobile firmy jest oparty na dialogu; nasłuchiwanie klienta i razem Definiowanie strategii. Ten element, aby odnieść sukces jest niezbędne do uzgodnienia potrzeb użytkowników, cele biznesowe i możliwości oferowanych przez platformy. Jego zespół opracowujący doskonałą wydajność grafiki, technologii i środowisko użytkownika i przyjmuje uwagę konkretnych aspektów wybranej platformy.|
|[SOFOS snc](http://www.sofos.it )|Bolonia, Miasto Bolonia Metropolitarnym, Włochy||
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Fenrir Inc.](http://www.fenrir-inc.com/)|Osaka, Japonia Tokio, Japonia Nagoya, Japonia|Fenrir developes aplikacji internetowych i mobilnych dla systemów iOS, Android i Windows |
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Diatom przedsiębiorstwa](http://www.diatomenterprises.com/)|Ryga, Łotwa|Opracowujemy poszczególnych sieci Web, mobilnych i klasycznych systemów, które wielką literą siłę indywidualizm biznesowych naszych klientów|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Bit rozwiązań i usług doradczych GmbH](https://www.bitsolutions.ch)|Balzers, Liechtenstein|Bit rozwiązań i usług doradczych opracowuje poszczególnych aplikacji sieci web, mobilnych i klasycznych|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[AGILUX](https://agilux.lu)|Pommerloch, Luksemburg|Agilux jest komputer firm specjalizującym się w obszarze integracja rozwiązań IT do zarządzania komercyjnych i ewidencjonowanie aktywności MSP, programowanie aplikacji mobilnych i witryn sieci Web, handlu elektronicznego|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Chemia kodu](http://www.codechem.com)|Skopje, Macedonia|Chemia kodu zapewnia Wytwarzanie oprogramowania, zarządzanie projektami i konsultacji usług. |
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Alset](http://alset.com.mx)|Mexico City, Mexico|ALSET to firma specjalizująca się w informacji o technologii informacyjnej (IT) przy użyciu rozległe doświadczenie w dostarczaniu branż dzięki rozwiązaniom stanu grafikę, zaawansowanych, niezawodnych i niezawodną|
|[Grupa Gigigo](http://www.gigigo.com)|Meksyk, Meksyk Sieć SAN Paulo, Brazylia; Madryt, Hiszpania|Założona w 2004 r. te latach Gigigo stał się stałych i niezawodne cyfrowego ally, kierowanie i towarzyszące duże korporacje za pomocą ich ścieżek rzecz transformacji cyfrowej|
|[InfoTacto](http://infotacto.com)|Mexico City, Mexico|Jesteśmy multidyscyplinarne grupy specjalistów za pomocą bogatych doświadczeń w zarządzania ryzykiem, kondycji, PESEL (emerytury planów i świadczeń socjalnych, schematy), bezpieczeństwo publiczne, technologiami sektora a komputerem hotelu.|
|[Narzędzia SA technologii Lisyx de CV](http://www.lisyx.com)|León, Guanajuato|Lisyx Technologies to firmie konsultingowej koncentruje się na rozwiązań informatycznych i procesów biznesowych. Zapewniają one usług doradczych w firm dostarczających wartości dodane i outsourcing usługi i rozwiązania IT nowej technologii.|
|[Migesa](http://www.migesa.com.mx/)|Monterrey, Leon sol, Meksyk; Meksyk, CDMX, Meksyk|Obecne na rynku ponad 35 lat. Migesa jest jednym z największych technologii informacji i komunikacji usług i rozwiązań integrator. Firma Microsoft projektować i implementować szukających rozwiązania na potrzeby średnich i dużych firm.|
...
|[Narzędzia TotalTech SA de CV](http://www.totaltech.com.mx)||omos expertos en desarrollo de aplikacje para z systemami iOS, Windows Phone y dla systemu Android. |
|[Xherstone](http://www.xherstone.com)|Naucalpan de Juárez, Meksyk|Xherstone to oprogramowanie, sieci web i aplikacji mobilnych firmy nad najnowocześniejszych technologii, z typu open source do personalizacji. Połączono wiedzy i doświadczenia technologicznych biznesowego.|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Technologie agile ](http://www.agiletz.com)|Dubaj, Zjednoczone Emiraty Arabskie; Kuwejt; Oman; Bahrajn; Katar; Kair, Egipt|Agile Technologies to IT przedsiębiorstwa dostawcy rozwiązań w zapewnieniu konsultacji szkoleniom i usługom wokół metodyki DevOps, programowania i testowania usługi.|
|[Wartość kodu](http://www.codevalue.net)|Herzliya, Izrael Yokne'am Illit, Izrael|Wartość kodu to wiodący firmy zajmującej się oprogramowaniem, zapewniając szerokim usług oprogramowania, które umożliwiają klientom skupienie się na ich podstawowej działalności|
|[Modułu d](http://www.dcube.me/)|Ar-Rijad, Arabia Saudyjska|Modułu d specjalizuje się w rozwoju elektronicznych multimediów i reklam, które wykonują zadania zapewnienie świecie Internetu Emiraty najlepsze środowisko produkcji i korzystanie z zawartości elektronicznej|
|[DigiPresence](http://www.digipresence.net)|Dubaj, Zjednoczone Emiraty Arabskie|Obecność Digi dostarcza, instaluje i zapewnia techniczne usług obsługi i utrzymania Directorate ogólne w miejscu zamieszkania użytkownika spraw zagranicznych Dubaj i jej centrów obcego.|
|[TechSource LLC](http://www.techsource.ae/)|Dubaj — Zjednoczone Emiraty Arabskie|Nasze usługi w zakresie od projektowania aplikacji i utrzymania rozwiązań integracji ERP, CRM i konsultacji funkcjonalności usług. W ciągu ostatnich kilku lat dostarczyliśmy znaczne ulepszenia wydajności w celu wiodących na Bliskim Wschodzie.|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Eksperci Cezar](http://www.caesarexperts.nl/)|Utrecht, Holandia|Eksperci Cezar projektuje, tworzy, implementuje i zarządza zaawansowane, innowacyjne rozwiązania ICT.|
|[Dalosy](https://dalosy.com)|Hendrik-Ido-Ambacht, Holandia| Dalosy zapewnia rozwiązań mobilnych, które spełniają potrzeb i wyzwań związanych z różnych firm i branżach każdego typu|
|[Elastique](https://www.elastique.nl/)|Hilversum, Holandia|Elastique to firma tworząca innowacyjnych aplikacji|
|[EsperantoXL](http://www.esperantoxl.nl)|Utrecht, Holandia|EsperantoXL specjalizuje się w opracowywaniu rozwiązań inteligentnych oprogramowania. Możemy pomóc organizacjom zwiększenie wydajności przez usprawnienie ich procesów|
|[Finaps](https://www.finaps.nl/)|Amsterdam, Holandia|Finaps zapewnia innowacyjne rozwiązania IT za pomocą zaawansowanej technologii, takich jak Mendix, sygnatury dostępu Współdzielonego, Xamarin i pola.|
|[Zwolnione](http://www.freed.nl/)|Achtkarspelen, Holandia|Zwolnione developes aplikacji internetowych i mobilnych dla systemów iOS, Android i Windows |
|[Holygrow](http://www.holygrow.nl )|Den Reino Capelle IJssel, Holandia|Korzystając z wykazując się odrobiną kreatywności, wiedzy, doświadczenia i pasji, możemy utworzyć produktów cyfrowych znaczące. Możemy to zrobić przy użyciu następujących czterech zdania.|
|[Puls i Internet Solutions](http://www.i-pulse.nl)|Doetinchem, Holandia|— Pulse kompilacje niestandardowego oprogramowania obu sieci web, aplikacji i nie tylko|
|[Konsultantów Ijsberg](http://www.ijsbergconsultants.nl)|Amsterdam, Holandia|Czy dotyczy projektowania biznesowego, strategii, innowacje, rozwoju produktów, orientacja klienta lub komunikację, IJsberg pomaga organizacjom w programie excel. Możemy to zrobić, formułowania dokładnego zintegrowanego podejścia|
|[Informacje o pomocy technicznej B.V.](http://www.infosupport.com)|Veenendaal, Holandia Mechelen, Belgia|Informacje o pomocy technicznej jest specjalistą w rozwoju, zarządzania i obsługi dostosowane oprogramowanie oraz dostarczanie rozwiązań analizy Biznesowej i integracja|
|[iQuality](http://www.iquality.nl)|Nijmegen, Holandia|Firma Microsoft projektowania, opracowywania i obsługi oprogramowania, aplikacji i witryn sieci Web na podstawie ambicji naszych klientów. |
|[KEMBIT B.V.](http://www.kembit.nl/)|Wijnandsrade, Holandia|Dzięki oczekiwaniu monitorowanych rozwoju i wynikowy musi możemy wprowadzić i weź pod uwagę odpowiednie, jakościowe, innowacyjnych i inteligentnych rozwiązań IT.|
|[Konsultacji KPN](https://www.kpnconsulting.nl/)|Zoetermeer, Holandia|Firmy KPN wizja zakłada rozszerzenie działalności jej znacznie więcej niż wdrożenia technologii. Zwiększenie vigor ludzi i organizacji jest ich priorytetu.|
|[Logirix](http://www.logirix.com/en/)|Groningen, Groningen|Logirix oferuje przyjazny dla użytkownika i funkcjonalności interfejsów, które łączenie potrzeb użytkowników końcowych przy organizacyjnych procesów i danych|
|[Macaw Nederland](http://www.macaw.nl)|Schiphol Rijk, Holandia Barendrecht, Holandia Apeldoorn, Holandia|Macaw projektuje, tworzy i zarządza technologii cyfrowych rozwiązań mobilnych, online, pakietu office i głównej. Są one specjalistów w dziedzinie biznesowych integracji, współpracy społecznościowej, chmury, automatyzacja marketingu, analiza biznesowa i przypisanie zasobów zewnętrznych.|
|[Nowe Mobile węzła](http://www.newnexusmobile.nl)|BW, Amsterdam|Nowe rozwiązania Mobile Nexus tworzy aplikacje biznesowe i konsumentów dla wszystkich platform. Nowe rozwiązania Mobile Nexus prowadzi organizacji w całym procesie: z consulting, aby realizacja i implementacji w tryb konserwacji.|
|[Otwieranie rozwiązań okrąg B.V.](http://www.opencirclesolutions.nl/en/)|Eindhoven, Holandia|Rozwiązania otwarte okrąg ma misji, aby upewnić się powiedzie, przy użyciu wiedzy i innowacji osób i klientów. Działają na tym i używać technologii typu Open Source: aplikacje biznesowe, aplikacje mobilne, integracja, analizy biznesowej i rozwoju produktu. Będą uważali w niestandardowych rozwiązaniach dostarczane przez nadzorowane przez kierowników projektów, przede wszystkim pracujący stosując metodę PRINCe2 podejście Agile/Scrum.|
|[Ordina zadań konfiguracji początkowej](https://www.ordina.com)|Nieuwegein, Holandia Groningen, Holandia Amsterdam, Holandia Eindhoven, Holandia Apeldoorn, Holandia|Ordina osiąga swojej misji, generując innowacjach zrównoważonej we współpracy z ich klientów. Są to osiągnąć przez kucie Zamknij relacje z klientami, ich. Te zaczyna się od inwestycje w relacji wzajemnego zaufania i zrozumienia. Ale to dopiero początek; Firma chce zapewnić trwałego rozwiązania, które naprawdę pomagają przejść do przodu. Projekty i programy opracowany bez marnowania man godzin i zasobów, które są co one są powinien zrobić i łatwe do zarządzania, który z kolei oznacza, że mają długi okres użytkowania.|
|[Punkt 42](http://www.point42.nl)|Reeuwijk, Holandia|Smartfony en tabletów halen de gewone komputer w tempo rszy w kWa aantal gebruikers. Uitstekende gebruikservaring op mobiele apparaten jest hierdoor belangrijker dan ooit. Punkt 42 werkt altijd vanuit een Mobile en przede gedachte en spitst zijn dienstverlening kółko op dynamiczne webdesign.|
|[Szybkie okrąg BV](http://www.rapidcircle.com/)|Amsterdam, Holandia Pune, Indie Melbourne, Australia|De digitale werkplek jest de vervanger van het bureaublad op de komputera. Wariant online de jest echter altijd beschikbaar, ook op mobiele apparaten. Voor de (mobiele) digitale werkplek rollen możemy de standardowe versie van usługi Office 365 uit. |
|[Redhotminute](http://www.redhotminute.com)|Tuil, Holandia||
|[Rubicon](http://www.rubicon.nl/diensten/mobiele-apps)|Postbus 169 4130 ED Vianen|Van visie tot strategie, projektowej tot programowania aplikacji, integratie spełnione ERP, testen, beheer en chmury. Wij hebben kennis van en ervaring spełnione het bouwen van mobiele oplossingen struktury passen bij uw individuele behoeften en kansen. Ontwerpt Rubicon, ontwikkelt, testowanie, wdrożone aplikacje beheert en. Spełnione zorgen onze "Aanpak mobilnej DevOps" Firma Microsoft voor een voorspelbare, betrouwbare en inzichtelijke ontwikkel en beheeraanpak voor uw aplikacjach.|
|[Versluis](https://gerald.verslu.is/)|Sittard, Holandia|W tej chwili, czy jestem głównie koncentrujących się na tworzeniu aplikacji, zwłaszcza w środkach platformy Xamarin i wszystko, co musi być korzystają z nich. Ale aplikacja nie jest kompletny bez procedur zaplecza właściwe prawo? Dlatego nie mam obawiasz się niektóre platformy ASP.NET (podstawowe) lub innych aplikacji sieci web. Chcę także tinker wokół z wszelkiego rodzaju inne czynności, takie jak: ciągłego dostarczania i ciągłej integracji, wszystko platformy Azure|
|[Xablu](http://www.xablu.com/)|Amsterdam, Holandia|Zwiększ możliwości zespołu deweloperów aplikacji za pomocą rozwiązania do tworzenia aplikacji platformy Xamarin, złożenia zespołów programistycznych i wspólnie określania źródła do tworzenia środowisk standardowych.|
|[Xpirit Nederland B.V.](https://xpirit.com)|Hilversum, Holandia|Stań specjalistom, chęć i możliwość wykonywały inaczej. Xpirit są innowatorów, enablers transformacji i wczesnych użytkowników, którzy przyjęli zmiany. Eksperci w nowej technologii firmy Microsoft.|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Enlighten projekty](https://www.enlighten.co.nz)|Auckland, Nowej Zelandii|Enlighten istnieje, aby przenieść wyjątkowo zaprojektowane i innowacyjnych i rozwiązań technologicznych w świecie nakierowanych na klienta. Korzystają z technologii firmy Microsoft do tworzenia aplikacji w języku C# dla systemów iOS, Android i Windows|
|[Hydrogen aplikacje Ltd](http://www.hydrogenapps.com)|Auckland, Nowej Zelandii|Dzięki wykorzystaniu ponad dziesięciu lat udostępniające pomyślnie platform na dużą skalę na całym świecie, Hydrogen oferuje bogate doświadczenie w dostawy oczekujących oprogramowania do nowej ery aplikacji, przenoszenia i tworzenia gier|
|[Pola magnetycznego rozwiązania Ltd](https://www.magnetismsolutions.com/)|Auckland, Nowej Zelandii; Christchurch, Nowej Zelandii|Firma Microsoft się rozpoczęcia każdej implementacji CRM, które udostępniamy naszych klientów. Posiadanie zostało pomyślnie uruchomione więcej niż 1500 z nich, możemy się z naszym zróżnicowanych i szerokiego zakresu portfolio tego bardzo dumna. Dzięki doświadczeniu w wielu krajach Implementowanie CRM oznacza, że firma Microsoft jest również umieścić i zapewnienie rozwiązania CRM. |
|[Występujące w wielu zebry](http://zebracrossing.co.nz/)|Taranaki, Nowej Zelandii|Korzystamy z technologii dla firm innowacji. Partner o kogoś, kto będzie nasłuchiwać do Ciebie, Dowiedz się, cele i dostarczania, co jest potrzebne.|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Technologia zaawansowanych systemów](http://www.astechoman.com/)|Maskat, Oman|AstechOman jest dostawcą rozwiązań IT. |
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Haiyan Group Inc.](http://www.haiyan.com.ph)|Manila, Filipiny|Haiyan Group Inc. developes aplikacji internetowych i mobilnych dla systemów iOS i Android|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Applandeo](http://www.applandeo.com/en/)|Kraków, Polska|Applandeo to firma tworząca sieci web i aplikacji|
|[ASSECO POLSKI SA](https://pl.asseco.com/)|Rzeszów, Polska|Polski Asseco opracowała rozwiązań programowych zaawansowanych technologicznie dla firm i instytucji wszystkich kluczy sektorów gospodarki ponad 20 lat|
|[Billennium](http://billennium.pl/)|Warszawa, Polska |Billennium ma wieloletnim doświadczeniu w rozwoju firm innowacyjnych narzędzi i rozwiązań.|
|[Krawędzi o.o. z jednego rozwiązania Sp.](http://www.edge1s.com)|Warszawa, Polska |Firma Microsoft zapewnia odpowiednie umiejętności i doświadczenie, wysoko wykwalifikowanych konsultantów IT. W ramach każdej usługi w nasze portfolio firma Microsoft gwarantuje, elastyczne podejście do potrzeb klienta i oczekiwania|
|[O.o. z NETBULLS Sp.](http://www.netbulls.io)|Bialystok, Polska|Pobierz swoje pomysły na rynek zdobyła. Bez ograniczenia marnowania £$ €, godziny lub kompromisów. |
|[SII](http://www.sii.pl/en)|Warszawa, Polska Paryż, Francja Madryt, Hiszpania Berlin, Niemcy Amsterdam, Holandia Bruksela, Belgia Miasto Luksemburg, Luksemburg Genewa, Szwajcaria; Marrakesz, Maroko; Praga, Czechia; Bukareszt, Rumunia Toronto, ON, Kanada; Santiago, Chile, Santiago Metropolitarnym regionu; Buenos Aires autonomicznego Miasto Buenos Aires, Argentyna; Bogoty, Bogota, Kolumbia Delhi, Indie|SII wiodących IT usług firma jest w Polsce obsługi programów transformację cyfrową od jego koncepcji pomyślnie dostarczanie i nie tylko. Firma Microsoft oferuje doświadczenie w dostarczaniu aplikacji firmowych i komercyjnych najpierw włączenie komunikacji urządzenia, dane big data, obsługi i w trybie offline.|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Agap2](http://www.agap2.com)|Lizbona, Portugalia|Agap2 — Europejskiego doradztwa operacyjną i grupy engineering specjalizującym się w branży i IT|
|[Współczynnik emisji dwutlenku przez BOLD](http://www.carbonbybold.com/)|Lizbona, Portugalia|Współczynnik emisji dwutlenku przez POGRUBIENIE, jest marki, koncentruje się na przenośnych usługi doradcze, pomagając firmom przenośnych integrowanie ich strategie biznesowe. |
|[WIG](http://www.wig.pt)|Lizbona, Portugalia|WIG ma położenie dodatnią, organicznych i dostosowane. Klienci będą widoczne jako partnerów i żyjemy problemów, tak jakby naszych. Wynik jest zawsze dodatnią, elastyczne, rzeczywiste i pragmatyczne.|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Binwell Ltd.](https://www.binwell.com)|St Petersburg, Rosja|Binwell projekty i kompilacje niestandardowego oprogramowania dostarczanie rozwiązań dobrze zaprojektowanych. Firma Microsoft zacznij, przechodząc od potrzeb biznesowych pozwolą Ci zrozumieć dokładnie 'value' możemy doprowadzić do klienta na każdym kroku|
|[Notissimus](http://notissimus.com)|Sankt Petersburg, Rosja|Twoja firma działa w sprzedaży lub usług? Jesteś we właściwym miejscu. Nowe projekty są zawsze-Zapraszamy!. |
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[INSSIO](http://inssio.com)|Belgrad, Serbia|Od koncepcji projektów do rozwijania aplikacji INSSIO jest przekształcany swoje pomysły firm oprogramowania, które są podstawą działania firmy|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[CyanSYS](http://www.cyansys.com)|Singapur; Kuala Lumpur, Malezja; Makati, Filipiny; Hongkong; Kinabalu kota, Sabah, Malezja; Dżakarta, Indonezja|CyanSYS dokłada wszelkich starań zapewnić skalowalność i jakości rozwiązania małych i średnich firm, umożliwiając im konkurować i rozwój za pomocą technologii informatycznych|
|[Xamariners](http://xamariners.com/)|Singapur|Możemy tworzyć aplikacje, które działa natywnie w systemach iOS, Android, Windows i Mac przy użyciu jednej bazy kodu, a także przyjazną Boty i rzeczywistość rozszerzone aplikacji.|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Logamic](https://www.logamic.com/)|Bratysława, Słowacja|Jeśli chcesz dodać dedykowanych deweloperem platformy Xamarin dla zespołu lub chcesz nam pokrycia całego procesu wdrażania dla Ciebie, lub czy po prostu chcesz zapoznać się z Xamarin opracowywania aplikacji mobilnych możesz skontaktować się z nami. |
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Systemy oprogramowania AD](http://www.adsoftsystems.co.za)|Kapsztad, Republika Południowej Afryki|Systemy oprogramowania AD oferuje niestandardowe sieci Web i rozwiązań mobilnych. Skupiają się na natywnych, ale również tworzenie rozwiązania umożliwiające maksymalne ponowne użycie na wszystkich głównych platformach mobilnych|
|[CodeWrite Pty Ltd](http://www.codewrite.co.za/)|Johannesburg, Republika Południowej Afryki|Skupimy się na stawiana jest mobilność rozwiązania opartego na aplikacji i opartego na sieci web, rozbudowane enterprise dostosowane aplikacje i integracja oprogramowania systemu kontroli dostępu do zabezpieczeń|
|[Cyberlogic Pty Ltd](http://www.cyberlogic.co.za)|Kapsztad, Republika Południowej Afryki|Cyberlogic jest dostawcą usługi zarządzanej w chmurze i usług IT z centrów danych zarządzanych|
|[Pełnego stosu](http://www.fullstack.co.za/)|Kapsztad, Republika Południowej Afryki|Pełny stos jest firmy zajmującej się oprogramowaniem, podając dane produktów i usług przeznaczonych do odblokowania wartość biznesową, poprzez dostarczanie jakości oprogramowania o czasie w stałej cenie.|
|[Nowy nośnik Labs](http://www.newmedialabs.com)|Kapsztad, Republika Południowej Afryki|Firma Microsoft specjalizują się w bezpieczny, transakcyjnych aplikacji sieci web dla klientów usług finansowych. Te systemy zamawianych są w pełni zintegrowane z firmom naszych klientów i dostarczać znaczne ulepszenia wydajności i możliwości, dzięki którym można zaangażować swoich klientów.|
|[Paradygmat grupy](http://www.paradigmgroup.co.za/)|Kapsztad, Republika Południowej Afryki|Grupa paradygmat jest podział rozwoju specjalista ds. oprogramowania w grupie. Im opracowywania niestandardowego oprogramowania należące do firmy, Pozarządowych i instytucji rządowych.|
|[Konsultacji Sabersoft](https://www.sabersoft.co.za/)|Republika Południowej Afryki|Firmy mogą teraz skorzystać z możliwości aplikacje mobilne, aby dotrzeć do nowych rynków, Uzyskaj świadomości, zwiększyć świadczenia usług i ostatecznie zwiększyć przychody.|
|[Tangens rozwiązań IT](http://tangentsolutions.co.za/)|Republika Południowej Afryki |Stycznej rozwiązania została założona w 2010 r. i jest dom doradcze rozwoju transformacji cyfrowej. Jesteśmy "open source" skupia się i korzystaj z uczestnictwa w szybkie realizowany i stale się zmieniają ekosystemu technologicznych. To pierwszy w chmurze, pierwszy DevOps i pierwszy Mobile. |
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[DevsDNA](http://www.devsdna.com)|Sewilli (Hiszpania)|W DevsDNA firma Microsoft uważa, inny sposób prowadzenia firmy i tworzenie oprogramowania jest możliwe. Niestety nasz współczesny społeczeństwa brakuje przezroczystości, etyki, zasad i kompas autorskie.|
|[KutirTech](http://www.kutirtech.com)|Malaga (Hiszpania)  |Przez ponad 13 lat firma Microsoft zostały tworzenia i obsługi aplikacji internetowych i mobilnych dla małych i dużych przedsiębiorstw klientów. Firma Microsoft stale zapoznaj się z i eksperymentować z najlepszych w klasie narzędzi i technologii i przenieść odpowiedniej kombinacji narzędzi i umiejętności, które zapewnią sukces naszym klientom przedsiębiorstwa.|
|[Pasiona konsultacji S.L](http://www.pasiona.com)|Barcelona, Hiszpania|Firma Microsoft były założona w 2007 z założeniem, że nasłuchiwania i angażowanie się w dialogu naszych klientów jest najlepszym sposobem zapewnienia nowatorskich rozwiązań technologicznych, które są dostosowane do potrzeb. Oznacza to, naszym celem a naszym raison Äôetre d ". Jesteśmy doradczych firmy wyspecjalizowane w opracowywaniu dostosowane rozwiązania dla każdej firmy, ponieważ każdy klient, jest inna i wymaga traktowania unikatowego i wyłącznego. Ponadto zobowiązujemy się do innowacji, wysoki komfort pracy, stałe szkolenia i wartość teaRegional przez ludzi w wersji Premier|
|[TalentoMobile](http://www.talentomobile.com/)|Hiszpania |Jesteśmy natives cyfrowych. Firma Microsoft digitize procesy biznesowe i połączenia z klientami, zarówno za pomocą naszych rozwiązań i naszych produktów.|
|[Vass Consultoria de Sistemas](http://www.vass.es/en)|Madryt, Hiszpania Barcelona, Hiszpania|VASS jest IT konsultacji potwierdzone, w 1999 r., wysoce specjalistyczne w nowych technologii i zintegrowane produktów i usług za pomocą gruntownej wiedzy i nadzoru nad technologii. Są one firmy wyczyść zobowiązania do rozszerzania międzynarodowych z obecnością w kilku krajach Europy i Ameryki. VASS to firma nacisk na społeczeństwa, % 2 tego zysków z akcjami społecznościowych.|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[BITZEAL](http://www.bitzeal.se)|Göteborga, Szwecja|Bitzeal sprawia, że aplikacje sieci web, telefonu i puplitu aplikacji i oprogramowania układowego|
|[Conevo IT konsultacji AB](http://www.conevo.se)|Sztokholm, Szwecja|Conevo jest IT firmy doradcze, która za pośrednictwem doskonałe czas odpowiedzi dla swoich klientów firmy, tworzyć rozwiązania IT najlepszym i najbardziej trwałego w sposób wydajny i humble|
|[Making Waves](http://www.makingwaves.com)|Sztokholm, Szwecja|Making Waves stosuje strategię, projektowania i usług technologicznych, aby pomóc przedsiębiorstwom bold Przekształcanie cyfrowe firmy. Za pomocą ponad 300 specjalistów wykwalifikowanych i nominowani one partnera innowacji, który oferuje wszystko, co jest potrzebne stają się cyfrowego zwycięzca.|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Arendi](http://www.arendi.ch/)|Hombrechtikon, Szwajcaria|Arendi oferuje szeroką gamę usług: opracowywanie aplikacji, sprzęt i oprogramowanie układowe rozwoju i zarządzanie projektami |
|[Grupa dostępności usługi oprogramowania BBV](http://www.bbv.ch)|Zürich, Szwajcaria|Usług oprogramowania BBV to szwajcarski oprogramowania i firm. Mogą oni rozwijać rozwiązań mobilnych, które są dostosowane do wymagań biznesowych określonych i złożone.|
|[AG inżynierii noser](http://www.noser.com)|Winterthur, Zürich |Noser jest Gold partnerem firmy Microsoft do tworzenia niestandardowych, mobilnych i rozwiązań biznesowych. Microsoft przyznała Noser AG inżynieryjnych, Gold certyfikowanym partnerem firmy Microsoft, zwycięzcę 2012 udzielania partnera firmy Microsoft Application Lifecycle Management (ALM). Ta award rozpoznaje oczekujących zaangażowania w dostarczanie rozwiązań technologicznych innowacyjnych i oprogramowaniu najwyższej jakości za pomocą ALM najlepsze praktyki.|
|[SPRL synapsis grupy](http://www.synapsis-group.com)|Bruksela |Nasz zespół programistyczny oprogramowania ma długie poświadczać pomyślne szukających i stałej cenie rozwoju dla małych i dużych firm. Na pulpicie, sieci Web lub platform urządzeń przenośnych (iOS/Android/Win8), mamy wszystkie zasoby potrzebne do przodu z projektem.|
|[Konferencji TechTalk](http://www.techtalk.at)|Wiedeń, Austria Zurych, Szwajcaria|Firma Microsoft zapewniają najlepszą w tworzeniu oprogramowania zaoszczędzić czas i pieniądze, zapewniając jakości. |
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[iScreen Corporation](http://www.iscreen.com)|Tajpej, Tajwan|iScreen opracowała podstawę na stałe technologii, za pomocą biznesowym skupienie się na konsultacji, projektowania i tworzenia aplikacji platform sieci Web i mobilnych wszystkie|
|[JetFusion Information Co., Ltd.](http://www.jetfusion.com.tw/)|Tajpej|Oferujemy opracowywania wysoce elastyczny, w czasie rzeczywistym i profesjonalnych oprogramowania i usług konstrukcji systemu i zapewniają również pełną enterprise information system rozwiązania.|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Hologram LTD](http://hologramsoft.com/)|Stambuł, Turcja|Hologram LTD jest dom rozwoju oprogramowania wszechstronna, pracy w obu firmowych i gier miejsce, koncentrujące się na wielu platformach|
|[Mobilist Bilisim Sistemleri](http://www.mobilist.com.tr)|Stambuł, Turcja|Firma Microsoft Podsumowując wysokiej jakości projekty inżynieryjne i inteligentnych aby przywołać innowacyjne rozwiązania.|


## <a name="uk"></a>ZJEDNOCZONE KRÓLESTWO

| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Funkcje adaptacyjnego sterowania finansowego ograniczone doradcze](http://weareadaptive.com)|London, UK|Funkcje adaptacyjnego sterowania finansowych Limited konsultacji to konsultacje za pomocą bogatych doświadczeń w branży finansowej|
|[Apptelic Ltd](http://Apptelic.com)|London, UK|Apptelic Ltd to firma tworząca oprogramowanie specjalizującym się w tworzeniu aplikacji mobilnych i klasycznych dla systemu iOS, Android, Windows i konsoli Xbox One.|
|[AppXib Ltd](http://www.appxib.com)|Peterborough, Zjednoczone Królestwo|AppXib to firma tworząca aplikację|
|[Blue Sparrow aplikacjach](http://www.bluesparrowapps.com/)|Bristolski, Zjednoczone Królestwo|Blue aplikacjach Sparrow jest award zwycięskiego aplikacji dla deweloperów firmy|
|[Fabryka aplikacji Chelsea](http://chelsea-apps.com/)|London, UK|CAF szybko wprowadziła nazwę dla siebie jako wiodący firma tworząca aplikację mobilną Zjednoczone Królestwo i terytorium narodowe największych specjalista ds. przenośnych doradztwem zarówno dla konsumentów i aplikacje dla przedsiębiorstw|
|[Wersja Ltd Londyn](http://getcodified.com/)|London, UK|Londyn wiodącego agencji React Native i Xamarin|
|[Cohaesus](http://cohaesus.co.uk)|London, UK|Cohaesus kompilacje natywne aplikacje dla niektórych współpracę z największych marek, wszystkie poprawne działanie jest gwarantowane w systemach iOS, Android i Windows Phone|
|[Contemi](http://www.contemi.com)|Programistów, Norwegia Odczyt, Zjednoczone Królestwo|Contemi jest programowanie IT i firmy doradcze przedsiębiorstwa się tworzeniem oprogramowania i z inicjatywy rozruchu.|
|[Creative nauki](https://creativesciences.co.uk)|London, UK|Creative Sciences udostępnia przenośnych i projektowaniu aplikacji internetowych, doradcze, desing i pomoc techniczną. |
|[Datadruid](http://www.datadruid.co.uk)|Firmy Bishop Stortford, Zjednoczone Królestwo|Zapewniając niezawodne i wysoko wydajnych aplikacji i usług deweloperskich. Wydana szybko i dostępna w konkurencyjnej|
|[Eastpoint oprogramowania](https://www.eastpoint.co.uk/)|London, UK|Jesteśmy DOM pełne rozwoju, zapewniając strategii i planowania, projektowania i środowiska użytkownika, rozwoju, testowania i obsługi i pomocy technicznej|
|[Element dziewięć 40](http://www.elementfortynine.com)|London, UK|Element dziewięć 40 jest przenośnych doradcze, skupiając się na aplikacjach, specjalizujących się w wielu opracowywania aplikacji mobilnych i maksymalizację kod ponownego użycia, przy jednoczesnym zapewnieniu, że środowisko użytkownika jest najwyższy priorytet|
|[Everis](http://www.everis.com)|London, UK|Everis jest wielonarodowe przedsiębiorstwa doradcze, która oferuje biznesowe i rozwiązania strategiczne, tworzenia i konserwacji aplikacji technologii i usług outsourcing|
|[Fujitsu](http://www.fujitsu.com/uk/services/application-services/application-development-integration/)||Fujitsu to wiodący japoński informacyjnymi i komunikacyjnymi technologii (ICT) Firma oferuje szeroką gamę technologii produkty, rozwiązania i usługi|
|[Futurice](http://futurice.com)|Londyn, Zjednoczone Królestwo; Monachium, Niemcy; Helskinki, Finlandia|Od 2001 r. Futurice pracował nad projektami ponad tysiąc ze swoimi klientami, ponad 200. Wiedzą, jak wygenerować innowacyjne pomysły i przekształcając oprogramowania, które działa|
|[Grupa Grove](http://www.groveis.com/)|Londyn, Zjednoczone Królestwo; Johannesburg, Republika Południowej Afryki|W Grove firma Microsoft odblokować sukcesu w biznesie za pomocą technologii. Możemy pomóc Ciebie i Twojej firmy, które spełniają swój potencjał poprzez wykorzystanie mocy najwyższą Cloud Computing, niestandardowe Software Development, Cyberbezpieczeństwa i analizy|
|[Guimak Ltd.](http://www.guimak.com)|London, UK|Firma tworząca gry|
|[W Ltd ręcznie](http://inthehand.com )|Newport, Shropshire, Zjednoczone Królestwo|Ltd. strony tworzy aplikacje i składniki dla urządzeń przenośnych, rzeczywistości mieszanej i systemy IoT|
|[Usługa BITS dla systemu iOS](http://iosbits.co.uk)|London, UK|BITY dla systemu iOS są enablers innowacje. Sposób tworzenia środowisk użytkowników zaawansowanych i narzędzi firmy creative używają nowych technologii, które znają|
|[iScientia Limited](http://www.iscientia.co.uk/)|Surrey, Zjednoczone Królestwo|Firma Microsoft oferuje doradztwa systemy informacji i rozwiązań głównie dla przemysłu Hotelarstwo, handlu detalicznego i płatności.|
|[Mikrosek](http://www.microsec.co.uk/)|Hampshire, Zjednoczone Królestwo|Przez ostatnie trzy dekady firma Mikrosek zostały zaprojektowane, opracowane i wspierane rozwiązań programowych przy użyciu praktycznie każdej technologii mainstream używany.|
|[Motech Ltd.](http://www.motechltd.com)|Londyn, Zjednoczone Królestwo; Ryga, Łotwa|Motech Ltd Enterprise Mobile rozwiązań jest Międzynarodowa firma, wykorzystując 12 + lat wiedzę w zakresie dostarczania aplikacji enterprise dla firmy globalne zapewnić najlepszą wartością w Enterprise Mobile Apps|
|[Ltd zarządzania pikseli](http://pml.co.uk)|Solihull, Middlands zachodnie Zjednoczone Królestwo|Projekty firmy PML wprowadzono aplikacje dla przedsiębiorstw, komercyjnych i edukacyjnych. Firmy podstawowej działalności obejmują wiele języków programowania, natywnych mobilnych i projektowanie aplikacji w chmurze systemów złożonych funkcji zabezpieczeń do przetwarzania obrazów, wideo kompresji i przesyłania strumieniowego. |
|[Proto oprogramowania](https://www.protosoftware.co.uk/)|Zjednoczone Królestwo|Firma Microsoft można tworzyć aplikacje mobilne dla swoją firmę na szeroką gamę platform, takich jak iOS, Android i Windows, zapewniając zasięg ponad 3 miliardy potencjalnych klientów. |
|[Rzadko niemożliwe](http://www.rarelyimpossible.com)|Bournemouth, Zjednoczone Królestwo|Aplikacje mobilne rzadko niemożliwe pomoc firmom kompilacji i rozwiązania IoT w chmurze do rozwiązywania problemów biznesowych, ze szczególnym uwzględnieniem środowiska użytkownika w fazie projektowania i programowania. Dzięki projektom i produktów, które tworzymy dla naszych klientów, naszym celem jest Zapewnij wszystkim użytkownikom w organizacji za pomocą narzędzi, które pomagają im w ich każdego dnia.|
|[Stałe wiedzy skale](http://www.rocksolidknowledge.com)|Bristolski, Zjednoczone Królestwo|Jak partnerzy Xamarin możemy ją tworzyć cross platform rozwiązań mobilnych przy użyciu narzędzia Xamarin Forms i natywnego interfejsu użytkownika dla systemów iOS i Android. Mamy doświadczenie w tworzeniu rozwiązań zapewniających, że natywnym interfejsem użytkownika, że podczas udostępniania wszystkich lub doskonałym postępowania kodu między platformami.|
|[Screenmedia](http://www.screenmedia.co.uk)|Glasgow, Zjednoczone Królestwo|Screenmedia uważa, że do tworzenia których środkiem człowieka rozwiązań dla klientów i użytkowników końcowych, użytkownicy muszą mieć ludzi, zorientowana biznesowych. Ich wizji i wartości pełni uwzględniała i oczywiście też ludzie. Kultura praktyki firmy Screenmedia to klucz w ich Powodzenie. Jego "Äôs co dyski i obsłuży ich ciągłych innowacji w nowych technologii; pomaga tworzy elastyczne partnerstwa z klientów. i "przyjemne pracy Äôs, co sprawia, że bardzo trudne.|
|[Sekwencja](https://www.sequence.co.uk/)|Cardiff w Wielkiej Brytanii; Londyn, Zjednoczone Królestwo|Sekwencja to twórczych Agencja cyfrowa ustanowionych w 1995 r. Specjalizujących się w środowisku projektowania, strategii i użytkownika, pracowali z niektórymi Brytyjskiej organizacje największych w branży podróży i turystyki — od produkcji. Marek nawiązywania połączenia z klientami za pośrednictwem pasją i wprowadzania innowacji.|
|[ShinobiSolutions](https://www.shinobicontrols.com/shinobienterprise)|Newcastle upon Tyne, Zjednoczone Królestwo|Od czasu jego powstania w 2011 r. Shinobicontrols ma były tworzone kompleksowe, zaawansowanych interaktywnych kontrolek interfejsu użytkownika dla deweloperów systemu Android i iOS. Przez 2012 uruchomił shinobicharts, ich pierwszym produktu. Od tamtej pory one "Äôve szybko zwiększyć, dlatego teraz zapewnienie interfejsu użytkownika rozwiązania tysiące klientów, nasze portfolio szybko rosnącą produktów.|
|[Skillweb](http://www.skillweb.co.uk)|Wycombe wysoka, Zjednoczone Królestwo|Skillweb jest firmy będących własnością prywatną, oparte na Zjednoczone Królestwo, która zapewnia rozwiązań technologicznych, które ułatwia organizacjom zarządzanie ich workforces mobilnych i śledzenie przepływu ich towarów. Firma działał od 1999 Zarządzanie wdrożeniami w Wielkiej Brytanii i Europie i jest odpowiedzialny za maksymalnie 100 milionów transakcji miesięcznie i rosnącą.|
|[Oprogramowanie, które można rozwiązać](http://www.softwaresolved.com/)|Exeter w Wielkiej Brytanii; Londyn, Zjednoczone Królestwo; Manchester, Wielka Brytania|Firma Microsoft tworzy długoterminowego partnerstwa z naszych klientów na podstawie relacji zaufania i dostarczania oprogramowania, zaległe. Jesteśmy partnerem Gold firmy Microsoft i naszym procesów są ISO 9001 certyfikat.  Oznacza to, że firma Microsoft akredytowana najwyższych standardów jakości podczas tworzenia oprogramowania.|
|[StyleTech](https://www.styletech.co.uk/)|Kadłuba, Zjednoczone Królestwo|Jesteśmy specjaliści ds. oprogramowania zamawianych tworzenie najnowocześniejszych, dostosowane rozwiązania, aby odpowiadał wymaganiom Äô naszych klientów podczas obsługując, utrzymywanie oraz udoskonalanie starszych systemów. Operacyjnego od 1999 r., firma Microsoft boast poświadczać dostarczania ponad 1000 projektów oprogramowania zamawianych szeregu różnych klientów ze sektorów prywatnych i publicznych, firma Microsoft specjalizują się w branży opieki zdrowotnej, naukowych, transportu, produkcji i branż technologii. Z kulturą przystępne i przyjaznego firma Microsoft zawsze zapewnia wąsko zdefiniowany, usługa jakości dla naszych klientów. Praca ze środowiskami Xamarin, Xamarin Test Cloud i Azure jesteśmy ekspertów na urządzeniu przenośnym, tablet i rozwoju chmury, sieci web lub na pulpicie i zawsze dotyczą najlepszym rozwiązaniem jest obszarach analizy, projektowania, zabezpieczeń, testowania i integracji.|
|[Superluminal](http://www.superluminalsoftware.co.uk)|Oxford, Zjednoczone Królestwo|W Superluminal jesteśmy programistów, dzięki czemu możemy projektowania naszego oprogramowania od podstaw, konstruowanie z krytycznych systemów, które są wyrównywane do procesu oraz funkcji hyper opłat Twojej firmy. Możemy również utrzymania i uaktualnianie bieżącego systemu, jeśli jego uruchomienie utrudnić lub wymaga zmiany w celu spełnienia potrzeb biznesowych.|
|[Zamawianych aplikacji Company Limited](http://www.thebespokeappcompany.co.uk)|Barrowford w Wielkiej Brytanii; Dystrykt Leicestershire zachodnie północno, Zjednoczone Królestwo||
|[Thumbmunkeys Ltd](http://www.thumbmunkeys.com)|Jorku, Yorkshire północnej, Zjednoczone Królestwo|Urządzenia z rekordem śledzenia, obejmującą, tworzenie aplikacji klienta za pomocą ponad 30 milionów pobrań aplikacji Thumbmunkeys wie, jak utworzyć plan udziału naprawdę wyjątkowe i angażowania użytkowników mobilnych. Nasze Zjednoczone Królestwo oparte zespołu doświadczonych deweloperów i projektantów oferty rozwiązań dostosowanych do potrzeb end-to-end z konsultacji do tworzenia prototypów, projekt interfejs użytkownika, programowanie dla wielu platform, projektowania aplikacji w chmurze i bieżące pomocy technicznej.|
|[VoxDev Ltd](http://www.voxdevmobile.com)|Durham w Wielkiej Brytanii|VoxDev powstał w 2003 i od naszych podstawy w Durham w Anglii of wschód Północna firma Microsoft pomyślnie pomogły klientów przy użyciu swoich projektów oprogramowania przy tworzeniu witryny sieci Web aplikacje klasyczne i mobilne.|
|[Waterstons LTD](https://waterstons.com)|Durham w Wielkiej Brytanii|Twórz lepsze biznesowe. Za pomocą technologii, doświadczenia i zobowiązania Waterstons działa wraz z setkami klientów, duże i małe, aby zwiększyć swoją działalność.|
|[Rozwiń IT](http://www.xpand-it.com)|Lizbona, Portugalia Londyn, Zjednoczone Królestwo|Za pomocą kilku lat doświadczenia w świecie zdominowanym i ponad 130 funkcji Mobile Apps dostępne w różnych rynków ro IT jest liderem w usług aplikacji mobilnych dla przedsiębiorstw.|
|[YARG Limited](http://www.yarg.com)|London, UK|YARG opracowuje aplikacje mobilne dla wielu platform dla telefonu iPhone, iPad, Android i Windows Phone. One pride osoby na dostarczaniu wartości, jakości produktów i wysokiego poziomu usługi osobistych.|
|[Systemy Zepto ograniczone](http://www.zeptosystems.com )|London, UK|Przekształcanie outsourcing i offshoring do określania źródła inteligentne. Zwiększenia pojemności wewnętrznych i umiejętności, korzystając z pracowników zdalnych, aby zaoszczędzić czas, koszt (nawet o 60%), zatrudniania i zachowaniu.|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[FreezePro oprogramowania](http://freezeprosoftware.com)|Lviv, Ukraina|Oprogramowanie FreezePro to opracowywania niestandardowego oprogramowania platformy i outsourcing firmy. Ustalono przez enterprising specjalistów za pomocą silnych tła IT.|
|[Ograniczone innowacje graficznego interfejsu użytkownika](http://www.gui-innovations.com)|Kijów, Ukraina|Zapewniamy świecie zdominowanym przez rozwiązania oparte na oprogramowaniu. Mamy bezkonkurencyjne pogłębiające wiedzę z zakresu projektowania, tworzenia i obsługi oprogramowania dla wielu platform|
|[Neadevis](http://neadevis.com/)|Lviv, Ukraina|Rozwiązania o wysokiej jakości i zadowolenia klienta są podstawowe informacje o naszej firmy. Naszych klientów na Upwork Prześlij nam opinię fantastyczne wyniki. Dowiedz się więcej na temat co mówią klienci o nas.|
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[Nareia](http://nareia.com.uy)|Urugwaj|Jesteśmy chcesz mieć wpływ na świecie zdominowanym, naprawdę uwielbiamy tworzenie niezwykłych aplikacji dla systemów iOS i Android, a następnie mamy wspaniałego środowiska programowania aplikacji mobilnych za pomocą platformy Xamarin.  |
...
| Partner | lokalizacje | Opis |
| --- | --- | --- |
|[DVLUP](http://www.dvlup.net/)|Ho Chi Minh City, Wietnam|Dev w górę została założona przez liderów społeczności deweloperów za pomocą o krytycznym poziomie deweloperom Wietnam|
|[FPT oprogramowania Hanoi Company Limited](http://www.fpt-software.com/)|Hanoi, Wietnam|Wietnam w największych i jednym z najszybciej rozwijająca się dostawca usług transformacji cyfrowej.|
