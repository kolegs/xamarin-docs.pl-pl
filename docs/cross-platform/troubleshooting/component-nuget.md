...
description: Ten dokument zawiera opis sposobu Zamień odwołania do składnika pakietów NuGet do zabezpieczenie przyszłych potrzeb aplikacji, ponieważ nie jest już magazynie składników Xamarin.
