...
(Dzięki temu można uniknąć błędów i działa w przypadku wszystkich aktualnych wersji programu Xamarin wszystkie warstwy 3.)
...
3. Zmień `portable-net45+win8+wpa81` do `portable-net45+win8+**wp8**+wpa81`:
...
`portable-net45+win8+wp8+wpa81` Wersji biblioteki nie odwołuje się do "System.Diagnostics.Tracing.dll" _na wszystkich_, przez co pozwala uniknąć całkowicie wszystkie warstwy 3 problemów.
...
## <a name="details-about-the-3-layers-of-errors"></a>Szczegółowe informacje o 3 warstwy błędów
...
###<a name="i-was-able-to-leave-linking-enabled-with-the-codeportable-net45win8wpa81code-version-of-the-library-on-older-versions-of-xamarinios-or-on-xamarinandroid-how-did-that-work"></a>"Była dostępna pozostaw łączenie z włączoną <code>portable-net45+win8+wpa81</code> wersji biblioteki na starsze wersje platformy Xamarin.iOS lub platformy Xamarin.Android. Jak to pomoże?"
...
System Windows: <code>C:\Program Files (x86)\Reference Assemblies\Microsoft\Framework\.NETFramework\v4.5\<strong>Facades</strong>\System.Diagnostics.Tracing.dll</code>
...
###<a name="will-it-help-if-i-manually-add-a-reference-to-the-systemdiagnosticstracing-facade-assembly"></a>"Będą pomocne, gdyby ręcznie dodać odwołanie do zestawu fasad"System.Diagnostics.Tracing"?"

W szczególności może rozwiązać ten problem, wykonując te kroki 2?

1. Kopiuj `System.Diagnostics.Tracing.dll` fasad zestawu w folderze projektu aplikacji z jednej z następujących lokalizacji:
...
2. Dodaj odwołanie do zestawu fasad w projekcie aplikacji platformy Xamarin.iOS lub platformy Xamarin.Android.
...
###"Można użyć <a href="https://www.nuget.org/packages/System.Diagnostics.Tracing/">pakietu System.Diagnostics.Tracing NuGet</a> rozwiązania tego problemu?"
