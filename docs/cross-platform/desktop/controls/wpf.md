...
description: Ten dokument porównuje i różni się znacząco WPF do platformy Xamarin.Forms. Zawarto informacje szablonów kontrolki, XAML, infrastruktura powiązań, szablony danych, ItemsControl, UserControl, nawigacji i adres URL nawigacji.
author: asb3993
ms.author: amburns
ms.date: 04/26/2017
