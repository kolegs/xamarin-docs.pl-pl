...
> [!NOTE]
> Deweloperzy systemu iOS należy zapoznać się z dokumentacją na [unikanie odwołania cykliczne w systemie iOS](~/ios/deploy-test/performance.md#avoid-strong-circular-references) zapewnienie swoje aplikacje efektywnie korzystać z pamięci.
...
Aby uzyskać więcej informacji na temat Inicjalizacja z opóźnieniem, zobacz [Incjalizacji](https://msdn.microsoft.com/library/dd997286(v=vs.110).aspx).
