...
description: Ten podręcznik opisuje różnych atrybutów i pojęcia, które są niezbędne do zrozumienia podczas tworzenia powiązania C# do bibliotek języka Objective-C.
ms.prod: xamarin
