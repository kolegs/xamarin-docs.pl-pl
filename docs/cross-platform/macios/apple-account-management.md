...
description: Ten dokument zawiera opis sposobu korzystania z funkcji zarządzania konta firmy Apple w programie Visual Studio for Mac i Visual Studio 2017 r.
ms.prod: xamarin
