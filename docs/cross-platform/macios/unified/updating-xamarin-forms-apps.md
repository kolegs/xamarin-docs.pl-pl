...
description: Ten dokument zawiera opis czynności, które należy przestrzegać podczas aktualizacji aplikacji platformy Xamarin.Forms z klasycznego interfejsu API Unified API.
ms.prod: xamarin
