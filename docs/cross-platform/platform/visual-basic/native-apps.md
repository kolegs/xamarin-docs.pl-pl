...
description: Ten przewodnik demonstruje sposób tworzenia natywnych aplikacji platformy Xamarin.iOS i Xamarin.Android, które używają reguły biznesowe napisane w języku Visual.
ms.prod: xamarin
