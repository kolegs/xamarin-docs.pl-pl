...
_CCDrawNode udostępnia metody rysowania obiektów pierwotnych, takich jak linie, okręgi i trójkąty._
...
## <a name="draw-methods-positions-are-relative-to-the-ccdrawnode"></a>Położenie metod rysowania jest względna do CCDrawNode
...
## <a name="draw-methods-do-not-need-to-be-called-every-frame"></a>Rysuj metody nie trzeba być wywoływana co ramki
