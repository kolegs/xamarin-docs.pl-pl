...
description: W tym dokumencie opisano CCDrawNode, który udostępnia metody rysowania obiektów pierwotnych, takich jak linie, okręgi i trójkąty.
ms.prod: xamarin
