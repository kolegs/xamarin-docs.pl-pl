...
description: Tym dokumencie opisano sposób korzystania z Wpięć do ciągłej integracji z aplikacjami platformy Xamarin. Zawarto informacje, jak instalowanie, konfigurowanie i używanie Wpięć.
ms.prod: xamarin
