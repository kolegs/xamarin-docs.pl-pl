...
Aby uzyskać więcej informacji o sposobie zgłaszania UITests do chmury testowej, zapoznaj się w tym przewodniku na [Xamarin.UITests przygotowywanie do przekazania](/appcenter/test-cloud/preparing-for-upload/uitest/).
...
- [Przygotowywanie fpr Xamarin.UITests przekazywania](/appcenter/test-cloud/preparing-for-upload/uitest/)
