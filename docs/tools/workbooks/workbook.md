...
description: Ten dokument zawiera opis sposobu umożliwia utworzenie na żywo dokumenty zawierające kod C# dla eksperymentowanie nauczania, szkolenia i eksplorowanie skoroszyty Xamarin.
ms.prod: xamarin
